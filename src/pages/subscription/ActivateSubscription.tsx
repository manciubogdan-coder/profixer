...
const ActivateSubscription = () => {
  ...
  // Verificăm dacă suntem înainte de 1 iulie 2025
          ...
          {isBeforeJuly2025 && (
            <div className="mt-4 p-4 bg-green-100 dark:bg-green-900 rounded-lg">
              <p className="text-green-800 dark:text-green-200 font-medium">
                Până la 1 iulie 2025, toți meșterii noi primesc acces gratuit la toate funcționalitățile platformei!
              </p>
            </div>
          )}
        </div>
        ...
        <div className="max-w-lg mx-auto">
          ...
          {isBeforeJuly2025 && (
            <p className="mt-4 text-sm text-center text-muted-foreground">
              Începând cu 1 iulie 2025, accesul la platforma ProFixer va fi disponibil doar pe bază de abonament.
            </p>
          )}
        </div>
      </div>
